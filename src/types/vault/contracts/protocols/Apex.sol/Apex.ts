...
export interface ApexInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "updateOperatorSigner",
    values: [AddressLike]
  ): string;
...
export interface Apex extends BaseContract {
  ...
  updateOperatorSigner: TypedContractMethod<
    [_operatorSigner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "updateOperatorSigner"
  ): TypedContractMethod<[_operatorSigner: AddressLike], [void], "nonpayable">;
